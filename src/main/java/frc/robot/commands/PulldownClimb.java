...
public class PulldownClimb extends CommandBase {
  private CANSparkMax m_motor;
  private CANPIDController m_pidController;
  private CANEncoder m_encoder;
  public double kP, kI, kD, kIz, kFF, kMaxOutput, kMinOutput, maxRPM, maxVel, minVel, maxAcc, allowedErr;
  /**
   * Creates a new PulldownClimb.
   */
  public PulldownClimb() {
  ...
  public void initialize() {
    // initialize motor
    m_motor = Robot.climb.climbMotor;
    ...
    m_pidController = Robot.climb.climbPID;
    m_encoder = Robot.climb.climbEncoder;
